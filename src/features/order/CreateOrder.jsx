      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="mt-2 rounded-md bg-red-100 p-2 text-center text-xs tracking-tight text-red-700">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            />
            {addressStatus === 'error' && (
              <p className="mt-2 rounded-md bg-red-100 p-2  text-xs font-bold tracking-tight text-red-700">
                {errorAddress}
              </p>
            )}
          </div>
